    ...
    return (
        <div className="container-information">
            ...
            <div className="section-description">
                ...
                <p>¡Hola! Soy Daniel, desarrollador FrontEnd con más de 3 años de experiencia. Amante de las matemáticas, la ciencia y la tecnología. He tenido la fortuna de trabajar con diversos equipos y empresas, me encanta proponer y discutir soluciones tecnologicas. </p>
